...
<div class="Cuerpo">
 ...
 <section class="form-register" style="margin-bottom: 50px;">
        ...
        <button type="button" class="btn btn-info" >
            <router-link id="Botones" :to="{ name: 'gestnotifi'}">Crear notificaciones</router-link>
        </button>
        </br>
        </br>
        <button type="button" class="btn btn-success">
            <router-link id="Botones" :to="{ name: 'gestcorreo'}">Enviar correos</router-link>
        </button>
        </br>
        </br>
        <button type="button"class="btn btn-warning">
            <router-link id="Botones" :to="{ name: 'gestnotifi'}">Administrar datos</router-link>
        </button>
    </section>
